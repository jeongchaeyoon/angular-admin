...
@Component({
  selector: 'analytics-connectpath-delete-panel',
  templateUrl: './analytics-connectpath-delete.component.html',
  styleUrls: ['./analytics.component.css']
})
export class AnalyticsConnectpathDeleteComponent implements OnInit {
  ...
  deleteKeyword(): void {
    ...
    let params = {
      ...
      keyowrd: this.analytics.name
    };
    this.analyticsService.deleteConnectpath(params).subscribe(json => {
